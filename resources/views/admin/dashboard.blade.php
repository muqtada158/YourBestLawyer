                ...
                <div class="container">
                    <div class="row avatar-upload">
                        <div class=" customer-avatar-box">
                            ...
                            <div class="avatar-preview">
                                ...
                                <img class="profile-user-img img-responsive img-circle" id="imagePreview" src="{{asset('images/super-admin.png')}}" alt="User profile picture">
                                <h4 class="customer-name font-18 mt-2 fw-bold font-accent">Admin</h4>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix-top-100 ">
                                            ...
                                            <li class="search-list">
                                                <a href="javascript:void()">
                                                    <div class="row xy-center">
                                                        <div class="col-md-10">
                                                            <p class="text-black fw-bold mb-0 mt-1"> Kindly enter minimum 3 numbers of case SR NO # to search or User's name</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                        ...
                        <div class="row mt-4 pt-4">
                            <div class="col-md-12">
                                <div class="ban_img">
                                    <img src="{{ asset('images/admin-banner.jpg') }}" alt="banner" border="0"
                                        class="w-100">
                                    <div class="ban_text">
                                        <h2 class="font-accent">Your Best Lawyer</h2>
                                        <h3 class="font-accent">Admin</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <a href="{{route('admin_attornies')}}">
                                <div class="card-body text-center">
                                    <span class="dash-card-icon">
                                        <img src="{{asset('images/svg/attorney-black.svg')}}">
                                    </span>
                                    <h3 class=" mt-4 dash-card-text ">Attorney</h3>
                                </div>
                            </a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            ...
                            <a href="{{route('admin_clients')}}">
                                <div class="card-body text-center">
                                    <span class="dash-card-icon">
                                        <img src="{{asset('images/svg/clients.svg')}}">
                                    </span>
                                    <h3 class=" mt-4 dash-card-text ">Customers</h3>
                                </div>
                            </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card dash-card">
                                <a href="{{route('admin_application')}}">
                                    <div class="card-body text-center">
                                        <span class="dash-card-icon">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card dash-card">
                            <a href="{{route('admin_cases')}}">
                                <div class="card-body text-center">
                                    <span class="dash-card-icon">
                                        <img src="{{asset('images/svg/cases-black.svg')}}">
                                    </span>
                                    <h3 class=" mt-4 dash-card-text ">Cases</h3>
                                </div>
                            </a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="card dash-card">
                            <a href="{{route('admin_payment_transactions')}}">
                                <div class="card-body text-center">
                                    <span class="dash-card-icon">
                        ...
                        {{-- <div class="col-md-4 mb-4">
                            ...
                            <a href="{{route('admin_schedule')}}">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class=" mt-4 dash-card-text ">Schedule</h3>
                                </div>
                            </a>
                            </div>
                        </div> --}}
                        {{-- <div class="col-md-4 mb-4">
                            ...
                            <a href="#">
                                <div class="card-body text-center">
                                    <span class="dash-card-icon">
                                        <img src="{{asset('images/svg/support.png')}}">
                                        <span class="count-carret">31</span>
                                    </span>
                                    <h3 class=" mt-4 dash-card-text ">Support</h3>
                                </div>
                            </a>
                            </div>
                        </div> --}}
                        <div class="col-md-4 mb-4">
                            ...
                            <a href="{{route('admin_contract',['Accepted'])}}">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class=" mt-4 dash-card-text ">Contract</h3>
                                </div>
                            </a>
                            </div>
                        </div>
