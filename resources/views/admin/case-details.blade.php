                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-7">
                                                    <p class="font-accent">
                                                        ...
                                                        <br>
                                                        <span class="font-14 fw-bold ">Case : {{isset($case->getCaseLaw) ? $case->getCaseLaw->title : ''}}</span>
                                                    </p>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <h4 class="fw-bold font-20 mb-0 col-lg-6 font-accent mt-4 mb-4">Attorney</h4>
                                                    <div class="row mt-4 mb-4 card-border-bottom">
                                                        ...
                                                        <div class="col-md-3 text-center">
                                                            ...
                                                            <div class="row text-end">
                                                                <div class="col-md-12">
                                                                    <a href="{{route('admin_contracts_details',[$customer_contract->id])}}" class="btn-primary w-100 d-block text-center p-1 mb-2 radius-10"> Go to contract</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        @else
                            @if($customer_contract)
                                <div class="row mt-4">
                                    ...
                                    <a href="{{route('admin_contracts_details',[$customer_contract->id])}}" class="btn-primary w-100 d-block text-center p-3 mb-2 radius-10"> View Contract</a>
                                    </div>
                                </div>
                            @endif
                        @endif
