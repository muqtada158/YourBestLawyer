                    ...
                    <div class="container">
                        <div class="row mt-4">
                            <div class="offset-md-2 col-md-2">
                                <a href="{{route('admin_all_cases',['all'])}}" class="{{ request()->segment(3) === 'all' ? 'btn-primary' : 'btn-secondary secondary' }} w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> All</a>
                            </div>
                            <div class="col-md-2">
                                <a href="{{route('admin_all_cases',['pending'])}}" class="{{ request()->segment(3) === 'pending' ? 'btn-primary' : 'btn-secondary secondary' }} w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Pending</a>
                            </div>
                            <div class="col-md-2">
                                <a href="{{route('admin_all_cases',['ended'])}}" class="{{ request()->segment(3) === 'ended' ? 'btn-primary' : 'btn-secondary secondary' }} w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Ended</a>
                            </div>
                            <div class="col-md-2">
                                <a href="{{route('admin_all_cases',['ongoing'])}}" class="{{ request()->segment(3) === 'ongoing' ? 'btn-primary' : 'btn-secondary secondary' }} w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Ongoing</a>
                            </div>
                        </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="offset-md-6 col-md-6">
                                                        <a href="{{route('admin_case_details',[$case->id])}}" class="btn-primary secondary w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> View</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
