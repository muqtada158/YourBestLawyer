                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:20px 0px 0px;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        align="center">
                                                                        <a href="https://yourbestlawyer.com/"
                                                                            target="_blank">
                                                                            <img align="center" border="0"
                                                                                src="{{asset('images/mail/MainLogo.png')}}" alt="image"
                                                                                title="image"
                                                                                style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 40%;max-width: 240px;"
                                                                                width="240"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                style="font-family: 'Open Sans',sans-serif; font-size: 15px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 140%;">Your verification code : <strong> {{$mailData['verification_code']}}</strong></p>
                                                            </div>
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    ...
                                                                                    <a href="https://www.facebook.com/profile.php?id=61567949253587"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{asset('images/mail/image-1.png')}}"
                                                                                            alt="Facebook"
                                                                                            title="Facebook"
                                                                                            width="32"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    ...
                                                                                    <a href="https://twitter.com/"
                                                                                        title="Twitter"
                                                                                        target="_blank">
                                                                                        <img src="{{asset('images/mail/image-2.png')}}"
                                                                                            alt="Twitter"
                                                                                            title="Twitter"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    ...
                                                                    <table align="center" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://www.linkedin.com/company/yourbestlawyer-com-llc/"
                                                                                        title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="{{asset('images/mail/image-3.png')}}"
                                                                                            alt="LinkedIn"
                                                                                            title="LinkedIn"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    ...
                                                                    <table align="center" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://www.instagram.com/yourbestlawyer.com_llc/"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{asset('images/mail/image-4.png')}}"
                                                                                            alt="Instagram"
                                                                                            title="Instagram"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">All
                                                                    rights reserved. <span
                                                                        style="line-height: 22.4px;"><span
                                                                            style="color: #c3a68a; line-height: 22.4px;">YourBestlawyer.com</span></span>
                                                                </p>
                                                            </div>
