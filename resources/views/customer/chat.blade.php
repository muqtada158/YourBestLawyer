                ...
                <div class="customer-portal-section p-3 p-md-5 background-attorney">
                    ...
                    <div class="customer-portal-content py-3">
                        ...
                        <div class="container mt-4 pb-4">
                            ...
                            @if ($converse[0]['lastMessage'] !== null)

                            @forelse ($converse as $conversation)
                                <div class="row mt-2">
                                    <a href="{{route('customer_messages',[$conversation['attorney']->id])}}">
                                        <div class="col-md-12">
                                            <div class="card border-0">
                                                <div class="row">
                                                        ...
                                                        <div class="icon-large">
                                                            <div class="text-center">
                                                                <img class="message-user-icon"
                                                                    src="{{ asset($conversation['attorney']->getUserDetails->image) }}"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <div class="pt-2">
                                                            <p class="font-accent">
                                                                <span class="font-20 fw-bold accent-color-2">{{ $conversation['attorney']->getUserDetails->first_name . ' ' . $conversation['attorney']->getUserDetails->last_name }}</span>
                                                                <br>
                                                                @if (isset($conversation['lastMessage']->message))
                                                                <small class="accent-color-3">{!! truncate_text($conversation['lastMessage']->message == ' ' ? '<i class="fa-solid fa-paperclip"></i> Attachments' : $conversation['lastMessage']->message, 60) !!}</small>
                                                                @else
                                                                    ...
                                                                @endif
                                                    ...
                                                    <div class="col-md-3 text-center xy-center">
                                                        <div class="row xy-center accent-color-3">
                                                            ...
                                                            @if($conversation['unreadCount'] > 0)
                                                                <span class="badge bg-danger w-50">{{ $conversation['unreadCount'] }}</span>
                                                            @endif
                                                            @if (isset($conversation['lastMessage']->created_at))
