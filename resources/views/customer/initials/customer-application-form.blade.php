...
@section('page_title', 'Your Best Lawyer | Application Form')
...
<style>
    ...
    .visible {
        max-height: 1000px; /* Adjust as necessary to fit the content */
        ...
        <div class="padding-section-medium registration-form-section design-section-2">
            <div class="customer-portal-section-without-grid p-3 p-md-5 background-attorney">
                <div class="customer-portal-content py-3">
                    <form id="application-form" action="{{route('customer_initial_intake_application_store_lego')}}" method="POST" enctype="multipart/form-data"> @csrf
                        <div class="row" class="step" id="step-1">
                                    ...
                                    <div class="card radius-20 app-card-for-image">
                                        <label for="videoUpload">
                                            <div class="card-body text-center circle background-primary">
                                                ...
                                                <input type='file' id="videoUpload" multiple class="image-picker"
                                                    name="video[]" />
                                                <div class="text-center">
                                                    @error('video.*')
                                                        <span class="text-danger">
                            ...
                            <div class="mt-5 col-12 d-flex flex-column gap-4 ">
                                ...
                                <div id="button_div" class="hidden d-flex flex-column gap-4">
                                    <h5 class="font-accent">
                                        <strong>Note: </strong>
                                        <label class="font-18 mb-2" for="package">You have to submit
