        ...
        <div class="padding-section-medium registration-form-section design-section-2">
            <div class="customer-portal-section p-3 p-md-5 background-attorney">
                ...
                <div class="customer-portal-content py-3">
                    <h2 class="fw-bold font-28 mb-0 col-lg-6 font-accent">Current Potential Cases</h2>
                    <div class="container">
                        <div class="row mt-4">
                                ...
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-4 text-center">
                                            ...
                                            <div class="row xy-center">
                                                    <a href="{{route('customer_case_details')}}" class="btn-primary w-100 d-block text-center p-1 mb-2 radius-10"> View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
