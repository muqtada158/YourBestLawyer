                ...
                <div class="customer-portal-content py-3">
                    ...
                    <div class="row ">
                        <div class="col-md-12 mt-4">
                            <form action="{{route('customer_dashboard_schedule_appointment_store')}}" method="POST" enctype="multipart/form-data"> @csrf
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="offset-md-8 col-md-4 mt-2">
                                            <button type="submit"  onclick="showLoader();" class="btn-primary d-block text-center w-100 p-1 mb-2 pt-3 pb-3 radius-10"> Add Appointment</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
