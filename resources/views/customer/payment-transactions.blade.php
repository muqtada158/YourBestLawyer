                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="card radius-20 border-0">
                                    ...
                                    <div class="card-body">
                                        <h4 class="font-accent fw-bold py-3 px-3">Invoices</h4>
                                        <div class="container">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <di class="offset-md-3 col-md-3">
                                                                    <div class="pt-2">
                                                                        ...
                                                                        <a href="{{route('customer_transactions',[$invoice->id])}}" class="btn-primary w-100 d-block text-center radius-10"> View</a>
                                                                    </div>
                                                                </di>
                                                            </div>
                                                        </div>
