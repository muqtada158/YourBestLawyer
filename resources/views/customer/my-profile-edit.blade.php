            ...
            <div class="padding-section-medium registration-form-section design-section-2">
                <div class="customer-portal-section p-3 p-md-5 background-attorney">
                    ...
                    <div class="customer-portal-content py-3">
                        ...
                        <form action="{{ route('customer_profile_update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row ">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="container mb-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        <label class="font-18 mb-2" for="phone">DOB</label>
                                                        <input name="dob" value="{{ $user->getUserDetails->dob }}"
