                ...
                <div class="customer-portal-content py-3">
                    ...
                    <div class="container">
                        <div class="row mt-4 mb-4">
                            <div class="col-md-2">
                                <a href="{{route('customer_invite')}}" class="btn-secondary w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Invite</a>
                            </div>
                            <div class="col-md-2">
                                ...
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3 text-center xy-center">
                                            <a href="{{route('customer_invite_send')}}" class="btn-primary w-100 d-block text-center p-1 mb-2 radius-10"> Invite</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
