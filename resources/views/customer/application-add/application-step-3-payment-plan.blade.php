                                            ...
                                            <div class="customer-portal-content p-4">
                                                <div class="row" class="step">
                                                    ...
                                                    <div class="col-12 d-flex flex-column gap-4 ">
                                                            ...
                                                            <div class="card border-0 radius-20 mt-4">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <label class="font-18 mb-2 fw-bold mt-2">Selected Case:</label>
                                                                        <label class="font-18 mb-2">{{$case->getCaseLaw->title}}</label>
                                                                        <label class="font-18 mb-2 fw-bold mt-2">Selected Case Subcategory:</label>
                                                                        <label class="font-18 mb-2">{{$case->getCaseLawSub->title}}</label>
                                                                        <label class="font-18 mb-2 fw-bold mt-2">Selected Package:</label>
                                                        ...
                                                        <div class="col-12 d-flex flex-column gap-4 ">
                                                            <form action="{{ route('customer_dashboard_payment_plans_store') }}" method="POST">
                                                                @csrf
                                                                <div>
