...
@section('page_title', 'Your Best Lawyer | Application Preview')
                                ...
                                <div class="card radius-20 border-0">
                                    <div class="card-body p-4">
                                        <div class="customer-portal-content p-4">
                                            <form action="{{route('customer_dashboard_case_submit')}}" method="POST" enctype="multipart/form-data">@csrf
                                                <div class="row">
                                                    ...
                                                    <div class="mt-5 col-12 d-flex flex-column gap-4 ">
                                                        ...
                                                        <div class="card border-0 radius-10 ">
                                                            <div class="card-body">
                                                                <div class="container">
                                                                    <h2 class="fw-bold font-28 mb-0 col-lg-4 font-accent mb-4">Case Infomation</h2>
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="row">
                                                                            ...
                                                                            @if ($application->getCaseLawSub)
                                                                                <div class="row mt-4">
                                                                                    <p class="fs-5">{{$application->getCaseLawSub->title}}</p>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="row">
                                                                                <p class="fs-5">{{$application->getCasePackage->title}}</p>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="container">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="row">
                                                                                <p class="fs-5">**** **** **** {{$application->getUser->getUserPaymentDetailsOne->card_last_four}}</p>
                                                                                <small class="small-text">Card number</small>
                                                                            </div>
                                                                            <div class="row mt-4">
                                                                                <p class="fs-5">{{$application->getUser->getUserPaymentDetailsOne->card_expiry_month}} / {{$application->getUser->getUserPaymentDetailsOne->card_expiry_year}}</p>
                                                        ...
                                                        <div class="card border-0 radius-10 pt-4 pb-4">
                                                            <div class="card-body">
                                                                <div class="container">
                                                                    <h2 class="fw-bold font-28 mb-0 col-lg-4 font-accent mb-4">Payment Plans</h2>
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="row mt-4">
                                                                        ...
                                                                        <div class="col-md-12 mt-2">
                                                                            <div class="text-center">
                                                                                <div class="row">
                                                                                    ...
                                                                                    @if ($application->getCasePackage->sub_cat_id == 18 || $application->getCasePackage->sub_cat_id == 19 || $application->getCasePackage->sub_cat_id == 20)
                                                                                        <h3 class="font-primary mb-0">{{$application->getCaseBid->bid}}%</p>
                                                                                    @else
                                                                                        <h3 class="font-primary mb-0">$ {{$application->getCaseBid->bid}}</p>
                                                                                    @endif
                                                                                </div>
                                                        ...
                                                        <div class="text-end">
                                                            <button class="align-self-end btn btn-primary text-white py-2 px-5 font-20 radius-10" type="submit" onclick="showLoader();">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
