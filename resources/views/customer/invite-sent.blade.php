...
@section('page_title', 'Your Best Lawyer | Invite Sent')
        ...
        <div class="padding-section-medium registration-form-section design-section-2">
            <div class="customer-portal-section p-3 p-md-5 background-attorney">
                ...
                <div class="customer-portal-content py-3">
                    <h2 class="fw-bold font-28 mb-0 col-lg-6 font-accent">Sent Invites</h2>
                    <div class="container">
                        <div class="row mt-4 mb-4">
                            ...
                            <div class="col-md-2">
                                <a href="{{route('customer_invite_received')}}" class="btn-primary w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Received</a>
                            </div>
                            <div class="col-md-2">
                                <a href="{{route('customer_invite_sent')}}" class="btn-secondary w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Sent</a>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3 text-center d-flex align-items-center">
                                            <div class="font-accent accent-color-3">
