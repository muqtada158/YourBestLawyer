                ...
                <div class="container">
                    <div class="row avatar-upload">
                        <div class=" customer-avatar-box">
                                <a href="{{route('attorney_profile')}}">
                                    <div class="avatar-edit">
                                            {{-- <input type='file' accept=".png, .jpg, .jpeg" readonly/>
                                            <label id="imageUpload"  for="imageUpload"></label> --}}
                                    </div>
                                </a>
                    ...
                    <div class="row clearfix-top-100 ">
                        ...
                        <div class="row mt-4 pt-4">
                            <div class="col-md-12">
                                <div class="ban_img">
                                    <img src="{{ asset('images/banner-attorney.jpg') }}" alt="banner" border="0" loading="lazy"
                                        class="w-100">
                                    <div class="ban_text">
                                        <h2 class="font-accent">Your Best Lawyer </h2>
                                        <h3 class="font-accent">Attorney</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row text-center">
                        <div class="offset-md-3 col-md-3">
                            <div class="mt-2 mb-2">
                                <a href="{{route('attorney_schedule')}}" class="btn btn-secondary-4 w-100 icon-btn">
                                    <img src="{{asset('images/svg/calendar.png')}}">
                                    <span class="btn-text-dash"> Schedule </span>
                                    {{-- <span class="count-carret-invite">4</span> --}}
                                </a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mt-2 mb-2">
                                <a href="{{route('attorney_contract_accepted')}}" class="btn btn-secondary-4 w-100 icon-btn">
                                    <img src="{{asset('images/svg/Contract.svg')}}">
                                    <span class="btn-text-dash"> Contracts </span>
                                    @if (isset($contracts) AND $contracts > 0)
                                        <span class="count-carret-invite">{{$contracts}}</span>
                                    @endif
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <a href="{{route('attorney_faqs')}}">
                                <div class="card-body text-center">
                                    <span class="dash-card-icon">
                                        <img src="{{asset('images/svg/faqs.svg')}}">
                                    </span>
                                    <h3 class=" mt-4 dash-card-text ">FAQ's</h3>
                                </div>
                            </a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            ...
                            <a href="{{route('attorney_profile')}}">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class=" mt-4 dash-card-text ">My Profile</h3>
                                </div>
                            </a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="card dash-card">
                                <a href="{{route('attorney_leads')}}">
                                    <div class="card-body text-center">
                                        @if (countLeads() > 0)
                                            <span class="count-carret-invite">{{countLeads()}}</span>
                                        @endif
                                        <span class="dash-card-icon">
                                            <img src="{{asset('images/svg/application.svg')}}">
                                        </span>
                                        <h3 class=" mt-4 dash-card-text ">Leads</h3>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="card dash-card">
                            <a href="{{route('attorney_payment_transactions')}}">
                                <div class="card-body text-center">
                                    <span class="dash-card-icon">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card dash-card">
                            <a href="{{route('attorney_chat_list')}}">
                                <div class="card-body text-center">
                                    <span class="dash-card-icon">
