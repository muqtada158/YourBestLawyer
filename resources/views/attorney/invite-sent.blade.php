                ...
                <div class="customer-portal-content py-3">
                    ...
                    <div class="container">
                        <div class="row mt-4 mb-4">
                            <div class="col-md-2">
                                <a href="{{route('attorney_invite')}}" class="btn-primary w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Invite</a>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <a href="{{route('attorney_invite_sent')}}" class="btn-secondary w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Sent</a>
                            </div>
                        </div>
