        ...
        <div class="padding-section-medium registration-form-section design-section-2">
            <div class="customer-portal-section-without-grid p-3 p-md-5 background-attorney">
                <div class="customer-portal-content py-3">
                    ...
                    <form action="{{route('attorney_update_profile_form')}}" method="POST" enctype="multipart/form-data">@csrf
                    <div class="row ">
                            ...
                            <div class="card border-0 radius-10 pt-4 pb-4">
                                <div class="card-body">
                                        <div class="container mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label class="font-18 mb-2" for="client-name">First Name</label>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <label class="font-18 mb-2" for="client-name">Last Name</label>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <input  name="dob" value="{{old('dob')}}" placeholder="DOB" id="dob" class="form-control-lg height-60 w-100 radius-20 input-border form-input form-input-medium" type="text" readonly>
                                                    @error('dob')
                                                        <span class="text-danger">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <label class="font-18 mb-2" for="client-name">Bio</label>
                                                    <textarea name="bio" placeholder="Bio" id="bio" class="form-control-lg w-100 radius-20 input-border form-input form-input-medium" style="height: 150px;"  cols="30" rows="10">{{old('bio')}}</textarea>
                                                    @error('bio')
                                                        <span class="text-danger">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="container mt-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input  name="current_password" placeholder="Current Password" class="form-control-lg height-60 w-100 radius-20 input-border form-input form-input-medium" type="password">
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <input  name="new_password" placeholder="New Password" class="form-control-lg height-60 w-100 radius-20 input-border form-input form-input-medium" type="password">
                                                    @error('new_password')
                                                        <span class="text-danger">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <input  name="password_confirmation" placeholder="Confirm Password" class="form-control-lg height-60 w-100 radius-20 input-border form-input form-input-medium" type="password">
