                ...
                <div class="customer-portal-content py-3">
                    ...
                    <div class="row ">
                        <div class="col-md-12 mt-4">
                            <form action="{{route('attorney_dashboard_schedule_appointment_store')}}" method="POST" enctype="multipart/form-data"> @csrf
                                <div class="container mb-4">
                                    <div class="row">
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <select name="case_sr_no" id="case_sr_no" class="form-control-lg height-60 w-100 radius-20 input-border form-input form-input-medium">
                                                ...
                                                @foreach ($cases as $case)
                                                    <option value="{{$case->getCaseDetail->sr_no}}">{{$case->getCaseDetail->sr_no}}</option>
                                                @endforeach
                                            </select>
                                            @error('case_sr_no')
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <input type="hidden" id="appointee_id" value="" name="customer_id">
...
<script>
    $(document).ready(function() {
        $('#case_sr_no').change(function() {
            ...
            var attorneyId = {{auth()->user()->id}};

            $.ajax({
                url: '{{ route("attorney_get_appointment_details") }}', // Adjust this to your actual route
                type: 'GET',
                data: {
                    case_sr_no: caseSrNo,
                ...
                success: function(response) {
                    if(response.success) {
                        ...
                        Toast.fire({
                            icon: 'error',
                            title: 'Failed to fetch case details.'
                        })
                    }
                },
                error: function() {
