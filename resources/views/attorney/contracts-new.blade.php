...
@section('page_title', 'Your Best Lawyer | New Contracts')
        ...
        <div class="padding-section-medium registration-form-section design-section-2">
            <div class="customer-portal-section p-3 p-md-5 background-attorney">
                ...
                <div class="customer-portal-content py-3">
                    <h2 class="fw-bold font-28 mb-0 col-lg-6 font-accent">New Contracts</h2>
                    <div class="container">
                        <div class="row mt-4">
                            <div class="offset-md-3 col-md-3">
                                <a href="{{route('attorney_contract_accepted')}}" class="btn-secondary w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> Accepted</a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{route('attorney_contract_new')}}" class="btn-primary w-100 d-block text-center p-1 mb-2 pt-3 pb-3 radius-10"> New</a>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-7 border-box-left">
                                            <div class="pt-2">
                                                <p class="font-accent">
                                                    <span class="font-20 fw-bold">{{$contract->getCustomer->getUserDetails->first_name}} {{$contract->getCustomer->getUserDetails->last_name}}</span>
                                                    <br>
                                                    <small class="accent-color-3">SR#{{$contract->getCaseDetail->sr_no}}</small>
                                                    <br>
                                        ...
                                        <div class="col-md-3 text-center">
                                            <div class="row text-end mb-2 mt-2">
                                                <div class="offset-md-4 col-md-8">
                                                    <label class="btn-pending w-100 d-block text-center radius-10 pt-1 pb-1"> New</label>
                                                </div>
                                            </div>
