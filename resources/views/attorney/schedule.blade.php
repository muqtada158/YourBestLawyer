            ...
            <div class="customer-portal-section p-3 p-md-5 background-attorney">
                ...
                <div class="customer-portal-content py-3">
                    ...
                    <div class="container">
                        ...
                        <div class="row mt-2">
                            @forelse ($schedules_upcoming as $schedule)
                                <div class="col-md-4 mt-4">
                                    <div class="card radius-20 border-0 bg-primary">
                                        <div class="card-body">
                                            <div class="row">
                                                <h3 class="font-20 font-accent text-white">Customer # {{$schedule->getCustomers->getUserDetails->first_name}} {{$schedule->getAttornies->getUserDetails->last_name}}</h3>
                                                <h3 class="font-20 font-accent text-white">SR # {{$schedule->case_sr_no}}</h3>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const myEvents = JSON.parse(localStorage.getItem('events')) || [
            ...
            {
                id: '{{$key}}',
                title: `{{$schedule->getCustomers->getUserDetails->first_name}} | SR #{{$schedule->case_sr_no}}`,
