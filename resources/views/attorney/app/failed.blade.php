...
@section('page_title', 'Your Best Lawyer | Onboarding Failed')
@push('css')
    <style>
        header {
            display: none;
                    ...
                    <div class="customer-portal-content py-3">
                        <div class="row">
                            <div class="offset-md-2 col-md-8 text-center">
                                ...
                                <h4 class="font-accent mt-5">Stripe onboarding <span class="text-danger">failed</span>, Please try again to proceed....</h4>
                            </div>
                        </div>
                    </div>
                </div>
